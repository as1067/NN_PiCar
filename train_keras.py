...
dropout = .4
model = Sequential()
model.add(l.Conv2D(512,activation="relu",kernel_size=(3,3),input_shape=(60,80,1),data_format="channels_last"))
model.add(l.Conv2D(256,activation="relu",kernel_size=(3,3),data_format="channels_last"))
